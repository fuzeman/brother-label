...
@click.option('-d', '--device', type=click.Choice(BrotherDeviceManager().keys()), envvar='BROTHER_LABEL_DEVICE')
...
@click.option('-m', '--media', envvar='BROTHER_LABEL_MEDIA', help='The label (size, media - die-cut or endless). Run `brother_label info labels` for a full list including ideal pixel dimensions.')
